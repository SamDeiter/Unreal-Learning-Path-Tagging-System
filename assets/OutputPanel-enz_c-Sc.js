import{f as A,g as R,u as D,j as i}from"./index-DuD93t7K.js";import{a as d}from"./vendor-cytoscape-hdah7_Xt.js";import{g as F,a as z,b as I}from"./generationEngine-B2_S3x5C.js";import{a as B}from"./data-courses-5fEGG3Qt.js";import{m as Y,a as q,n as J}from"./vendor-firebase-DXZ8tGTv.js";import{g as U,a as X,d as V}from"./PersonaService-C3UxAABM.js";import"./TagGraphService-DCZX6Gn4.js";const H=e=>{if(!e||e.length===0)return[];const t=new Set;e.forEach(r=>{r.tags?.topic&&t.add(r.tags.topic),r.topic&&t.add(r.topic)});const n=[],l=new Set;return t.forEach(r=>{B[r]&&B[r].forEach(a=>{l.has(a.url)||(l.add(a.url),n.push({...a,topic:r}))})}),n};function _(e){return Array.isArray(e?.tags)?e.tags:Array.isArray(e?.extracted_tags)?e.extracted_tags:[]}let w=null,E=null,P=null;function W(){if(w)return!0;if(!A.apiKey||A.apiKey==="undefined")return!1;try{return w=R(),E=q(w),P=J(w,"us-central1"),!0}catch(e){return console.error("Firebase initialization failed:",e),!1}}function O(){return W()?!!E?.currentUser:!1}async function K(e,t){if(!t||t.length===0)return k(e,t);const n=t.map((a,s)=>{const m=_(a).slice(0,5).join(", "),x=a.role||"Core";return`${s+1}. "${a.title}" [${x}] - Tags: ${m||"General UE5"}`}).join(`
