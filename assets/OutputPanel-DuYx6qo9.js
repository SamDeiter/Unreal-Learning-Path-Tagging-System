import{f as L,g as B,u as E,j as n}from"./index-BxglCNbu.js";import{a as g}from"./vendor-cytoscape-hdah7_Xt.js";import{g as D,a as R,b as _}from"./generationEngine-B1vkzw2O.js";import{a as A}from"./data-courses-CecwKQwF.js";import{m as I,a as P,n as F}from"./vendor-firebase-DNc0QRT5.js";import"./TagGraphService-gHp_uqjt.js";const z=e=>{if(!e||e.length===0)return[];const t=new Set;e.forEach(a=>{a.tags?.topic&&t.add(a.tags.topic),a.topic&&t.add(a.topic)});const o=[],s=new Set;return t.forEach(a=>{A[a]&&A[a].forEach(i=>{s.has(i.url)||(s.add(i.url),o.push({...i,topic:a}))})}),o};function N(e){return Array.isArray(e?.tags)?e.tags:Array.isArray(e?.extracted_tags)?e.extracted_tags:[]}let $=null,U=null,M=null;function J(){if($)return!0;if(!L.apiKey||L.apiKey==="undefined")return!1;try{return $=B(),U=P($),M=F($,"us-central1"),!0}catch(e){return console.error("Firebase initialization failed:",e),!1}}function O(){return J()?!!U?.currentUser:!1}async function q(e,t){if(!t||t.length===0)return w(e,t);const o=t.map((i,l)=>{const m=N(i).slice(0,5).join(", "),f=i.role||"Core";return`${l+1}. "${i.title}" [${f}] - Tags: ${m||"General UE5"}`}).join(`
