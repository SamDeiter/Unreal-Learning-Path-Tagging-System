...
Learning Agents is an experimental plugin and should not be used in production games at this time.

This is the 5.4 version of the Learning Agents course. 5.5 can be found here: https://dev.epicgames.com/community/learning/courses/GAR/unreal-engine-learning-agents-5-5/bZnJ/unreal-engine-learning-agents-5-5
...
Check out the following page to learn what's new in Learning Agents with UE 5.4!


### Getting Started

Check out the following tutorial to begin getting familiar with Learning Agents.
...
- Learning Agents Intro (5.4)
- What's New in Learning Agents? (5.4)
- Learning to Drive (5.4)
- Improving Observations & Debugging (5.4)
- Headless Training & Network Snapshots
- Setting up Tensorboard
- Learning to Drive: Imitation (5.4)