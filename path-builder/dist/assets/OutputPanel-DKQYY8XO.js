import{f as A,b as R,e as U,h as D,u as F,d as z,j as i}from"./index-DXajF3An.js";import{a as d}from"./vendor-cytoscape-hdah7_Xt.js";import{g as I,a as Y,b as q}from"./generationEngine-xr0tpCya.js";import{a as B}from"./data-courses-Cm1nXtlt.js";import{h as J,b as X,a as V}from"./vendor-firebase-C_IfBwJR.js";import"./TagGraphService-eSfQ5aLx.js";const H=e=>{if(!e||e.length===0)return[];const t=new Set;e.forEach(r=>{r.tags?.topic&&t.add(r.tags.topic),r.topic&&t.add(r.topic)});const n=[],l=new Set;return t.forEach(r=>{B[r]&&B[r].forEach(a=>{l.has(a.url)||(l.add(a.url),n.push({...a,topic:r}))})}),n};function _(e){return Array.isArray(e?.tags)?e.tags:Array.isArray(e?.extracted_tags)?e.extracted_tags:[]}let w=null,E=null,P=null;function W(){if(w)return!0;if(!A.apiKey||A.apiKey==="undefined")return!1;try{return w=R(),E=X(w),P=V(w,"us-central1"),!0}catch(e){return console.error("Firebase initialization failed:",e),!1}}function O(){return W()?!!E?.currentUser:!1}async function K(e,t){if(!t||t.length===0)return k(e,t);const n=t.map((a,s)=>{const m=_(a).slice(0,5).join(", "),x=a.role||"Core";return`${s+1}. "${a.title}" [${x}] - Tags: ${m||"General UE5"}`}).join(`
