/**
 * UefnDemandDashboard.jsx — UEFN Demand Intelligence Dashboard
 *
...
function UefnDemandDashboard() {
  ...
  return (
    <div className="uefn-demand-dashboard">
      {/* Header */}
...
export default UefnDemandDashboard;
