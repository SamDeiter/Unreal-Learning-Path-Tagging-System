/**
 * UefnDemandDashboard.test.jsx
 *
 * Unit + integration tests for the UEFN Demand Intelligence Dashboard.
...
vi.mock("../UefnDemandDashboard.css", () => ({}));

import UefnDemandDashboard from "../UefnDemandDashboard";
...
describe("UefnDemandDashboard", () => {
  ...
  it("renders loading spinner when loading with no report", () => {
    ...
    const { container } = render(<UefnDemandDashboard />);
