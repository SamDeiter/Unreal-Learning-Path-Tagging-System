...
export const QUIZ_IMAGE_BANK = {
  ...
  editor_panel: {
    image: "/quiz-images/details_panel.png",
  ...
  // Content Browser
  content_browser: {
    image: "/quiz-images/content_browser.png",
  ...
  // Blueprints
  blueprint: {
    image: "/quiz-images/blueprint_event_graph.png",
  ...
  // Casting
  casting: {
    image: "/quiz-images/cast_to_node.png",
  ...
  // Materials
  material: {
    image: "/quiz-images/material_editor.png",
  ...
  // World Outliner
  world_outliner: {
    image: "/quiz-images/world_outliner.png",
  ...
  // Viewport modes
  viewport: {
    image: "/quiz-images/viewport_wireframe.png",
  ...
  // Sequencer
  sequencer: {
    image: "/quiz-images/sequencer.png",
  ...
  // Mobility
  mobility: {
    image: "/quiz-images/mobility_setting.png",
  ...
  // Collision
  collision: {
    image: "/quiz-images/collision_settings.png",
