...
// Cache for course metadata to avoid redundant normalization and tag flattening
const courseMetadataCache = new WeakMap();

// Cache for normalized persona rules to avoid re-normalizing keywords on every call
...
/**
 * Helper to extract and cache lowercased metadata for a course.
 */
