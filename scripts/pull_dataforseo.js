...
if (taxonomyMatch && taxonomyMatch[1]) {
  const extractedTaxonomy = {};
  eval("extractedTaxonomy = " + taxonomyMatch[1]);
  Object.assign(taxonomy, extractedTaxonomy);
} else {
...
if (uefnMatch && uefnMatch[1]) {
  const extractedUefn = {};
  eval("extractedUefn = " + uefnMatch[1]);
  Object.assign(uefnTaxonomy, extractedUefn);
} else {
