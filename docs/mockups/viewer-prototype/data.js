...
const PATH_DATA = {
  ...
  chapters: [
      ...
      steps: [
        {
          ...
          objectives: [
            "Understand what a NavMesh is and why AI needs it",
            "Learn how UE5 calculates walkable surfaces",
            "Place and size a NavMesh Bounds Volume"
          ],
        ...
        },
        {
          ...
          keyTakeaways: [
            ...
            "Press P to visualize the green NavMesh overlay",
    ...
    // ── Chapter 2 ────────────────────────────────────────
    {
      ...
      description: "Build the base character blueprint and assign a specialized AI Controller.",
      steps: [
        {
          id: "ch2-s1", type: "AI_TRANSITION",
          objectives: [
            "Create a Character Blueprint for the AI enemy",
            "Understand the relationship between Pawns and Controllers",
            "Assign an AI Controller class to your character"
          ],
          expectedOutcome: "You'll have a standalone AI character in your level with its own AI Controller ready to receive behavior logic."
        },
        {
          ...
          keyTakeaways: [
            ...
            "Set 'AI Controller Class' in the character's defaults"
          ]
        },
        {
          id: "ch2-s3", type: "CONTENT_DOC",
          title: "State Tree Overview",
          content: "The AI Controller is the brain of your AI character. Unlike the Player Controller which receives input from a human, the AI Controller receives instructions from behavior systems like Behavior Trees or State Trees.\n\nWhen your AI Character is spawned into the world, Unreal automatically creates an instance of the assigned AI Controller class and 'possesses' the pawn.",
          relevantSnippet: "Navigate to your Character Blueprint → Class Defaults → AI Controller Class → Select your custom AIController.",
          codeBlock: "// In your AI Controller's BeginPlay\nvoid AMyAIController::BeginPlay()\n{\n    Super::BeginPlay();\n    // The controller automatically possesses\n    // the pawn it's assigned to\n    UE_LOG(LogTemp, Log, TEXT(\"AI Controller active\"));\n}",
          aiNotes: [
    ...
    // ── Chapter 3 ────────────────────────────────────────
    {
      ...
      description: "Activate and configure the State Tree system for AI decision-making.",
      steps: [
        {
          id: "ch3-s1", type: "AI_TRANSITION",
          objectives: [
            "Enable the State Tree plugin in Project Settings",
        ...
        },
        {
          ...
          keyTakeaways: [
            ...
            "Create a State Tree via Right-Click > AI > State Tree",
            "Assign it in the AI Controller's 'Run State Tree' component"
          ]
        },
        {
          id: "ch3-s3", type: "QUIZ",
    ...
    // ── Chapter 4 ────────────────────────────────────────
    {
      ...
      description: "Define the data flow and essential variables within the State Tree.",
      steps: [
        {
          id: "ch4-s1", type: "AI_TRANSITION",
          objectives: [
            "Add the AI Perception component to your AI Controller",
            "Configure the Sight sense with radius and angle",
            "Understand how AI Perception events fire"
          ],
        ...
        },
        {
          ...
          keyTakeaways: [
            ...
            "Set the player's 'AI Perception Stimuli Source' to generate stimuli",
            "Use 'On Target Perception Updated' delegate for events"
          ]
        },
        {
          id: "ch4-s3", type: "QUIZ",
      ...
      steps: [
        {
          ...
          objectives: [
            ...
            "Create an Evaluator that updates the target variable",
            "Understand how Evaluators run continuously in the background"
          ],
          expectedOutcome: "Your State Tree has a 'TargetActor' parameter that automatically updates when the AI Perception system detects or loses the player."
        },
        {
    ...
    // ── Chapter 6 ────────────────────────────────────────
    {
      ...
      description: "Program AI movement between designated waypoints using State Tree.",
      steps: [
        {
          id: "ch6-s1", type: "AI_TRANSITION",
          objectives: [
            "Create a 'Roam' state in the State Tree",
            "Add a task that picks a random NavMesh point",
            "Add a second task that moves the AI to that point",
            "Set up the loop so the AI continuously roams"
          ],
          expectedOutcome: "Your AI wanders around the level randomly, picking new destinations on the NavMesh and walking to them in an endless loop."
        },
        {
          ...
          keyTakeaways: [
            ...
            "Chain a 'Move To' task that walks the AI to that point",
      ...
      steps: [
        {
          ...
          objectives: [
            "Create a 'Chase' state in the State Tree",
            "Use the TargetActor parameter to move toward the player",
            "Understand how the Move To task works with actor targets vs. locations"
          ],
    ...
    // ── Chapter 8 ────────────────────────────────────────
    {
      ...
      description: "Run simulations, debug State Tree execution, and refine movement parameters.",
      steps: [
        {
          id: "ch8-s1", type: "AI_TRANSITION",
          objectives: [
            "Define transition conditions between Roam and Chase",
            "Use the TargetActor parameter to trigger transitions",
        ...
        },
        {
          ...
          aiNotes: [
            ...
            "Verify the TargetActor is being set by the Evaluator using the State Tree debugger"
          ]
        },
        {
          id: "ch8-s4", type: "QUIZ",
  ...
  completion: {
    skillsMastered: ["NavMesh", "AI Controller", "State Trees", "AI Perception"],
    totalSteps: 26,
    totalHours: 6,
    suggestedNext: [
      {
